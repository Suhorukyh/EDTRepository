...
//+ Порицкий А.Н. 30.05.2018 16:39:54
Функция _ВРег(Строка) Экспорт
	Возврат ВРег(Строка);
КонецФункции

Функция _ТРег(Строка) Экспорт
	Возврат ТРег(Строка);
КонецФункции

Функция _СтрЗаменить(Строка, ПодстрокаПоиска, ПодстрокаЗамены) Экспорт
