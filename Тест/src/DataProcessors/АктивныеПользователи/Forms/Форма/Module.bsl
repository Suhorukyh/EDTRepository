...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяКолонкиСортировки = "ИмяПользователя";
...
//&НаКлиенте
//Процедура ЗавершитьСеанс1(Команда)
...
Процедура ЗавершитьСеанс(Команда)
	МасивДляЗавершения=Новый Массив;
	
	Для каждого строка из Элементы.СписокПользователей.ВыделенныеСтроки Цикл
		
		МасивДляЗавершения.Добавить(Элементы.СписокПользователей.ДанныеСтроки(строка).Сеанс);
		
	КонецЦикла;
	
	Если МасивДляЗавершения.Количество() > 0 тогда
		УправлениеПользователямиСервер.ЗавершитьАктивныеСеансыИнформационнойБазы(МасивДляЗавершения);
	КонецЕсли;
